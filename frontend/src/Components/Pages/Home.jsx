  ...
  return (
    <>
							...
							<div className="col-lg-3 col-md-4 pd-left-none no-pd">
								<div className="main-left-sidebar no-margin">
									...
									<> {!!user && (<h1>{user.name}</h1>)}
										...
										<span>Département {!!user && (<h2>{user.departement}</h2>)}</span>
								...
								<div className="main-ws-sec">
									<div className="post-topbar">
										...
										<div className="post-st">
											<ul>
												<li><a className="post_project" href="#" title="">Ajout Evenement</a></li>
												<li><a className="post-jb active" href="#" title="">Ajout Publication</a></li>
											</ul>
										</div>
									</div>
		...
		<div className="chatbox-list">
				...
				<div className="conversation-box">
					<div className="con-title mg-3">
						...
						<div className="st-icons">
							...
							<a href="#" title="" className="close-chat"><i className="la la-minus-square"></i></a>
							<a href="#" title="" className="close-chat"><i className="la la-close"></i></a>
						</div>
					</div>
			...
			<div className="chatbox">
				<div className="chat-mg">
					<a href="#" title=""><img src="/assets/images/resources/usr-img2.png" alt=""/></a>
				</div>
				<div className="conversation-box">
					<div className="con-title mg-3">
						<div className="chat-user-info">
					...
					<div className="chat-list">
						<div className="conv-list active">
							...
							<div className="usy-info">
								<h3>John Doe</h3>
								<span>Lorem ipsum dolor <img src="/assets/images/smley.png" alt=""/></span>
							</div>

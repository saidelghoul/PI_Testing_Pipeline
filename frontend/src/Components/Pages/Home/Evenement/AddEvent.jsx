                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="cp-field">
                            ...
                            <div className="cpp-fiel">
                                <input type="text" id="nomgroups" placeholder="Titre" name="titre" value={formData.titre} onChange={handleChange} />
                            </div>
                        </div>
                        
                        <div className="cp-field">
                            <h5>Contenu</h5>
                            <textarea id="description" name="contenu" value={formData.contenu} onChange={handleChange} />
                        </div>
                        <div className="cp-field">
                            <h5>Date Début </h5>
                            <input type="datetime-local" name="datedeb"placeholder="Date de début" value={formData.DateDebut} onChange={handleChange} required/>    
                            </div>               
                        <div className="cp-field">
                            <h5>Date Fin</h5>
                            <input type="datetime-local" name="datefin"placeholder="Date de début" value={formData.DateDebut} onChange={handleChange} required/>                       
                        </div>
                        <div className="cp-field">
                            <h5>Capacité</h5>
                            <input type="number"name="cap" placeholder="Capacité" value={formData.cap} onChange={handleChange}required/>        
                         </div>
                        <div className="cp-field">
                            <h5>Prix</h5>

...
export default function Home() {
  ...
  const handelSubmitComentEvent = async (e) => {
    ...
    try {
      await axios.post(`/commentaire/addToEvent/${currentEventId}`, {
        ...commentData,
        creator: user.id, // Utilisez l'ID de l'utilisateur connecté
      });
      setCommentData({
                ...
                <div className="main-ws-sec">
                    ...
                    <div className="posty">
                      <div className="post-bar no-margin">
                        {publication.map((publication) => (
                          <div className="job-status-bar" key={publication._id}>
                  ...
                  <div className="posts-section">
                    <div className="posty">
                      <div className="post-bar no-margin">
                        {events.map((event) => (
                          <div key={event._id} className="job-status-bar">
                            <div className="post_topbar">
                              <div className="usy-dt">
                                <img
                                  src="/assets/images/resources/us-pc2.png"

										...
										<li className="active">
											<div className="usr-msg-details">
												...
												<div className="usr-mg-info">
													<h3>John Doe</h3>
													<p>Lorem ipsum dolor <img src="/assets/images/smley.png" alt=""/></p>
												</div>
							...
							<div className="main-conversation-box">
								...
								<div className="messages-line">
									<div className="main-message-box">
										...
										<div className="message-dt">
											<div className="message-inner-dt img-bx">
												<img src="/assets/images/resources/mt-img1.png" alt=""/>
												<img src="/assets/images/resources/mt-img2.png" alt=""/>
												<img src="/assets/images/resources/mt-img3.png" alt=""/>
											</div>
									...
									<div className="main-message-box st3">
										<div className="message-dt st3">
											<div className="message-inner-dt">
												<p>Cras ultricies ligula.<img src="/assets/images/smley.png" alt=""/></p>
											</div>
								...
								<div className="message-send-area">
									<form>
										...
										<ul>
											<li><a href="#" title=""><i className="fas fa-smile"></i></a></li>
											<li><a href="#" title=""><i className="fas fa-camera"></i></a></li>
											<li><a href="#" title=""><i className="fas fa-paperclip"></i></a></li>
										</ul>
									</form>
								</div>
							</div>

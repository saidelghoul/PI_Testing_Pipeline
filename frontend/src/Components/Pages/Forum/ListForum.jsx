...
export default function ListForum() {
  ...
  const currentSujets = filteredSujets.slice(
    indexOfFirstSujet,
    indexOfLastSujet
  );
                      ...
                      <div className="inner-main2">
                        <div className="inner-main-header2">
                          <span
                            ...
                            style={{ marginTop: "15px", marginLeft: "-21px" }}
                          >
                            🔎
                          </span>
                          <input
                                  ...
                                  <div className="card-body p-3">
                                    <div className="media forum-item">
                                      ...
                                      <div className="media-body">
                                        <h1>
                                          <Link
                                            to={`/ListeReplay/${sujet._id}`}
                                            className="text-body"
                                          >
                                            <b>{sujet.Creator.name}</b>
                                          </Link>
                                        </h1>
                                        <br />
                                        <h6>
                                        ...
                                        <p className="text-muted">
                                          ...
                                          <span className="text-secondary font-weight-bold">
                                            {moment(sujet.createdAt).fromNow()}
                                          </span>
                                        </p>
                                      </div>
                                      <div className="text-muted small text-center align-self-center">
                                        {user &&
                                          user.id === sujet.Creator._id && (
                                            <button
                                              onClick={() =>
                                                handleDelete(sujet._id)
                                              }

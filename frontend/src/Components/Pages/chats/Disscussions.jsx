...
export default function Discussions() {
  ...
  <form onSubmit={handleMessageSend}>
    <i className="icon fa fa-smile-o clickable" style={{fontSize: "25pt"}} aria-hidden="true" onClick={() => setShowEmojis(!showEmojis)}></i>
    {showEmojis && <Picker onEmojiClick={onEmojiClick} />}
    <input type="text" className="write-message" name="message" placeholder="Type your message here" value={messageInput} onChange={(e) => setMessageInput(e.target.value)} />
    <button type="submit"> <i className="icon send fa fa-paper-plane-o clickable" aria-hidden="true" type="submit"></i></button>
  </form>
</div>

                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="cp-field">
                            ...
                            <div className="cpp-fiel">
                                <input type="text" id="nomgroups" placeholder="Nom de la page" name="nomgroups" value={formData.nomgroups} onChange={handleChange} />
                            </div>
                        </div>
                        ...
                        <div className="cp-field">
                           <h5>Visibilité:</h5> 
                            <input type="checkbox" id="visibilite" name="visibilite" checked={formData.visibilite} onChange={handleChange} />
                        </div>
                        <div className="cp-field">
                           <h5>Image de Profile:</h5> 
                        <Form.Group controlId="formFileMultiple" className="mb-3" >
                        
                                 <Form.Control type="file" multiple name="profileImage" onChange={handlechangeFile} required />
                        </Form.Group>
                        </div>
                        <div className="cp-field">
                        ...
                        <Form.Group controlId="formFileMultiple" className="mb-3" >
                                 ...
                                 <Form.Control type="file" multiple name="coverImage" onChange={handlechangeFile} required />
                        </Form.Group>
                        </div>

            ...
            <section className="companies-info">
                <div className="container">
                    <div className="company-title d-flex justify-content-between align-items-center">
                        <h3>All Groups</h3>
                        <Link to="/addGroup" className="btn btn-danger" style={{ backgroundColor: '#dc3545' }}>Ajouter une autre page</Link>
                    </div>
                    <br></br>
                                    ...
                                    <div key={page._id} className="col-lg-3 col-md-4 col-sm-6">
                                        <div className="company_profile_info">
                                            <div className="company-up-info">
                                                ...
                                                <ul>
                                                    {user.id === page.creator && <li><Link to={`/modifier/${page._id}`} title="" className="follow"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-fill" viewBox="0 0 16 16">
  <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z"/>
</svg></Link></li>}
                                                    {user.id === page.creator && <li><Link to={`/notifications/${page._id}`} title="" className="follow">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bell-fill" viewBox="0 0 16 16">
                                                    <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2m.995-14.901a1 1 0 1 0-1.99 0A5 5 0 0 0 3 6c0 1.098-.5 6-2 7h14c-1.5-1-2-5.902-2-7 0-2.42-1.72-4.44-4.005-4.901"/>
                                                    </svg>
                                                        </Link></li>}

                                                    {user.id !== page.creator && <li><a href="/message"  title="" className="follow"><i className="fa fa-envelope"></i></a></li>}
                                                    {user.id === page.creator && <button onClick={() => handleDelete(page._id)} className="delete-us btn btn-danger">
                                                        <i className="fa fa-trash"></i>
                                                    </button>}
                                                </ul>
                                            </div>
                                            <Link to={`/groups/${page._id}`} title="" className="view-more-pro">View Profile</Link>
                                        </div>
                                    </div>
                                ))
                            )}

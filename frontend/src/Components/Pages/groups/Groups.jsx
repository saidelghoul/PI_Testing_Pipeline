...
export default function Groups() {
	...
	const participerPage = async () => {
        try {
            const response = await axios.post(`/groups/${id}/participer`,{ userId: user.id });
			
            console.log(response.data.message);
			alert('votre participation est bien effectuer attendez admin pour l acceptation');
			...
			if (error.response && error.response.data.error === "L'utilisateur participe déjà à ce groupe") {
  ...
  return (
    <>
		...
		<section className="cover-sec">
			<img src={`http://localhost:8000/images/${page.coverImage}`} alt="cover" style={{height:'362px'}}  />
		</section>
							...
							<div className="col-lg-3">
								<div className="main-left-sidebar">
									<div className="user_profile">
										...
										<img src={`http://localhost:8000/images/${page.profileImage}`} alt="Profile" />
										</div>
										<div className="user_pro_status">
											...
											<ul className="flw-hr">
												...
												<li><a href="#" onClick={participerPage} title="" className="flww"><i className="la la-plus"></i> Regoindre</a></li>
                              ...
                              Ajout Publication
									...
									<div className="product-feed-tab current" id="feed-dd">
										...
										<div className="user-profile-ov">
											<h3><a href="#" title="" className="overview-open">Description</a> </h3>
											<p>{page.description}</p>
										</div>
										<div className="user-profile-ov st2">
											<h3><a href="#" title="" className="esp-bx-open">Date création </a></h3>
										...
										<h3>Cette publication n'est pas visible.<br>
										</br>
									...
									<div className="product-feed-tab" id="info-dd">
										...
										<div className="user-profile-ov">
											<h3><a href="#" title="" className="overview-open">Description</a> <a href="#" title="" className="overview-open"><i className="fa fa-pencil"></i></a></h3>
											<p>{page.description}</p>
										</div>}
										<div className="user-profile-ov st2">
											<h3><a href="#" title="" className="esp-bx-open">Date création </a></h3>
										...
										<div className="user-profile-ov">
											<h3><a href="#" title="" className="emp-open">Total des participants</a> <a href="#" title="" className="emp-open"><i className="fa fa-pencil"></i></a> <a href="#" title="" className="emp-open"><i className="fa fa-plus-square"></i></a></h3>
											<span>17,048</span>
										</div>

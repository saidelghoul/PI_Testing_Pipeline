...
function EditTechnicalSkill() {
    ...
    const handleSaveTechnicalSkill = async () => {
        ...
        setLoading(true);
        await technicalSkillService.updateTechnicalSkill(id, data);
        setLoading(false);
    ...
    useEffect(() => {
        setLoading(true);
        const getTechnicalSkill = async () => {
            const data = await technicalSkillService.getTechnicalSkillById(id);
            setTechnicalSkill(data);
        }
    ...
    return (
        <>
            <div className='p-4 mt-5'>
                ...
                <h1 className='h3 my-4 text-center'>Mise à Jour d'une compétence technique</h1>

                ...
                <div className="col-lg-3">
                    <div className="acc-leftbar">
                        <div className="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a className="nav-item nav-link" id="nav-privcy-tab" data-toggle="tab" href="#privcy" role="tab" aria-controls="privacy" aria-selected="false"><i className="fa fa-group"></i>Requests</a>
                            <a className="nav-item nav-link" id="security" data-toggle="tab" href="#security-login" role="tab" aria-controls="security-login" aria-selected="false"><i className="fa fa-user-secret"></i>Security and Login</a>
                            <a className="nav-item nav-link" id="nav-privacy-tab" data-toggle="tab" href="#privacy" role="tab" aria-controls="privacy" aria-selected="false"><i className="fa fa-paw"></i>Privacy</a>
                            <a className="nav-item nav-link" id="nav-blockking-tab" data-toggle="tab" href="#blockking" role="tab" aria-controls="blockking" aria-selected="false"><i className="fa fa-cc-diners-club"></i>Blocking</a>
                        ...
                        <div className="acc-setting">
                            ...
                            <div className="requests-list">
                                <div className="request-details">
                                    <div className="noty-user-img">
                                        <img src="/assets/images/resources/r-img1.png" alt="" />
                                    </div>
                                ...
                                <div className="request-details">
                                    <div className="noty-user-img">
                                        <img src="/assets/images/resources/r-img2.png" alt="" />
                                    </div>
                                    <div className="request-info">
                                        <h3>John Doe</h3>
                                ...
                                <div className="request-details">
                                    <div className="noty-user-img">
                                        <img src="/assets/images/resources/r-img3.png" alt="" />
                                    </div>
                                    <div className="request-info">
                                        <h3>Poonam</h3>
                                ...
                                <div className="request-details">
                                    <div className="noty-user-img">
                                        <img src="/assets/images/resources/r-img4.png" alt="" />
                                    </div>
                                    <div className="request-info">
                                        <h3>Bill Gates</h3>
                                ...
                                <div className="request-details">
                                    <div className="noty-user-img">
                                        <img src="/assets/images/resources/r-img5.png" alt="" />
                                    </div>
                                    <div className="request-info">
                                        <h3>Jessica William</h3>
                                        <span>Graphic Designer</span>
                                ...
                                <div className="request-details">
                                    <div className="noty-user-img">
                                        <img src="/assets/images/resources/r-img6.png" alt="" />
                                    </div>
                                    <div className="request-info">
                                        <h3>John Doe</h3>
                                        <span>PHP Developer</span>
